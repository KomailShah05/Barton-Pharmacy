...
!(function (e, t) {
  ...
  W.on(
    ...
    W.on(window, "load.bs.carousel.data-api", function () {
      for (
        ...
        Q.carouselInterface(e[t], k(e[t], "bs.carousel"));
    }),
    b(function () {
      var e = y();
      if (e) {
  ...
  var ot = nt(),
    st = nt({ defaultModifiers: [Ae, Ke, Pe, he] }),
    rt = nt({ defaultModifiers: [Ae, Ke, Pe, he, Ve, Ue, Ze, Oe, Qe] }),
    at = Object.freeze({
      __proto__: null,
      popperGenerator: nt,
      detectOverflow: Ge,
      ...
      return (
        (r = function (t) {
          ...
          S.id && D.attr("id", S.id),
            ...
            E.find(".xdsoft_month span").after(W),
            E.find(".xdsoft_year span").after(F),
            E.find(".xdsoft_month,.xdsoft_year").on(
          ...
          E.find(".xdsoft_select")
            ...
            D.on("open.xdsoft", function (t) {
              ...
              .on("close.xdsoft", function (t) {
                var i = !0;
                E.find(".xdsoft_month,.xdsoft_year")
                  .find(".xdsoft_select")
                  .hide(),
                  S.onClose &&
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  function p(e, t, i, n, o) {
    ...
    for (l = 0; l < x; l++)
      (d = (f = e[k]).a),
        ...
        (g = o
          ? ((b = s[l]),
            (w = (((_ = r[l]) + b) * t * 0.25) / (n ? 0.5 : a[l] || 0.5)),
            c -
    ...
    ((f = e[k]).b = T),
      ...
      (f.ca = f.c - f.a),
      (f.ba = T - f.a),
      i && ((y = h(f.a, T, f.c, f.d)), e.splice(k, 1, y[0], y[1], y[2], y[3]));
  }
  function m(e, t, i, n) {
    var o,
      a,
    ...
    if (n)
      for (a = (e = [n].concat(e)).length; -1 < --a; )
        "string" == typeof (u = e[a][t]) &&
          "=" === u.charAt(1) &&
          (e[a][t] = n[t] + Number(u.charAt(0) + u.substr(2)));
    if ((o = e.length - 2) < 0)
      return (h[0] = new f(e[0][t], 0, 0, e[0][t])), h;
    for (a = 0; a < o; a++)
      (l = e[a][t]),
        (d = e[a + 1][t]),
        (h[a] = new f(l, 0, 0, d)),
  ...
  function g(e, t, i, n, o, d) {
    ...
    for (s.length = r.length = a.length = 0, c = w.length; -1 < --c; )
      (u = w[c]),
        (l[u] = -1 !== o.indexOf("," + u + ",")),
        (_[u] = m(e, u, l[u], d));
    for (c = s.length; -1 < --c; )
      (s[c] = Math.sqrt(s[c])), (r[c] = Math.sqrt(r[c]));
    if (!n) {
      for (c = w.length; -1 < --c; )
        if (l[u])
          for (v = (f = _[w[c]]).length - 1, h = 0; h < v; h++)
            (g = f[h + 1].da / r[h] + f[h].da / s[h] || 0),
              (a[h] = (a[h] || 0) + g * g);
      for (c = a.length; -1 < --c; ) a[c] = Math.sqrt(a[c]);
    }
    for (c = w.length, h = i ? 4 : 1; -1 < --c; )
      p((f = _[(u = w[c])]), t, i, n, l[u]),
        y && (f.splice(0, h), f.splice(f.length - h, h));
    return _;
  }
  function v(e, t, i) {
    for (
      ...
      set: function (e) {
        ...
        if (this._timeRes) {
          ...
          a =
            1 === e
              ? 1
              : (n + (f - this._s1) / (this._s2 - this._s1)) * this._prec || 0;
        } else
          a =
    ...
    _gsScope._gsDefine(
      ...
      function (e, t) {
        ...
        var T,
          ...
          ae =
            ((A = re.indexOf("Android")),
            (M = u("a")),
            (C =
              -1 !== re.indexOf("Safari") &&
              -1 === re.indexOf("Chrome") &&
              (-1 === A || 3 < parseFloat(re.substr(A + 8, 2)))),
              ...
              (-1 === n.indexOf(",") && -1 === i.indexOf(",")) ||
                ((O =
                  -1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl")
                    ? ((C = C.join(" ").replace(Q, ", ").split(" ")),
                      O.join(" ").replace(Q, ", ").split(" "))
        ...
        var Me,
          ...
          Ve = (se.getTransform = function (e, i, n, o) {
            ...
            var s,
              ...
              c,
              u,
              f = (n && e._gsTransform) || new qe(),
              h = f.scaleX < 0,
              p =
                ($e &&
                  (parseFloat(ue(e, He, i, !1, "0 0 0").split(" ")[2]) ||
                    f.zOrigin)) ||
                0,
            ...
            if (
              ...
              if (16 === s.length) {
                var g,
                  ...
                  L = Math.atan2(O, E);
                f.zOrigin &&
                  ((A = j * (z = -f.zOrigin) - s[12]),
                  (M = P * z - s[13]),
                  (z = E * z + f.zOrigin - s[14])),
                  (f.rotationX = L * Z),
                  L &&
                  ...
                  (f.scaleZ =
                    ((1e5 * Math.sqrt(j * j + P * P + E * E) + 0.5) | 0) / 1e5),
                  (w /= f.scaleX),
                  (S /= f.scaleY),
                  (x /= f.scaleX),
                  (C /= f.scaleY),
                ...
                (f.x = s[4] || 0),
                  ...
                  (u = B || H ? Math.atan2(B, H) * Z + c : f.skewX || 0),
                  (f.scaleX = l),
                  (f.scaleY = d),
                  (f.rotation = c),
                  (f.skewX = u),
                  ...
                  f.svg &&
                    ...
                    (f.y -= f.yOrigin - (f.xOrigin * R + f.yOrigin * H)));
              }
                ...
                return (
                  (D =
                    "function" == typeof T.transformOrigin
                      ? T.transformOrigin(E, P)
                      : T.transformOrigin),
                  O.svg &&
                    (D || T.svgOrigin) &&
                    ((m = O.xOffset),
                    (g = O.yOffset),
                    Ee(e, ge(D), c, T.svgOrigin, T.smoothOrigin),
                    (s = xe(
                      O,
                      "xOrigin",
                      (b ? O : c).xOrigin,
          ...
          (d._onInitTween = function (e, t, a, d) {
            ...
            if (
              ...
              "string" == typeof t &&
                ...
                (x.cssText = h + ";" + t),
                (c = v(e, c, g(e)).difs),
                !ae && H.test(t) && (c.opacity = parseFloat(RegExp.$1)),
                (t = c),
                (x.cssText = h)),
              t.className
                ? (this._firstPT = u =
          ...
          (d.parse = function (e, t, i, s) {
            ...
            for (r in t) {
              if (
                ((f = t[r]),
                (a = l[r]),
                "function" != typeof f || (a && a.allowFunc) || (f = f(E, P)),
                a)
              )
  ...
  (function (e, t) {
    ...
    (f = A.ticker = new g.Ticker()),
      ((u = A.prototype)._dirty = u._gc = u._initted = u._paused = !1),
        ...
        if (this._timeline) {
          ...
          this._gc && this._enabled(!0, !1),
            (this._totalTime === e && 0 !== this._duration) ||
              (H.length && ee(), this.render(e, t, !1), H.length && ee());
        }
        return this;
      }),
    ...
    ((u = z.prototype = new A()).constructor = z),
      (u.kill()._gc = !1),
    ...
    ((u = L.prototype = new A()).constructor = L),
      (u.kill()._gc = !1),
      (u.ratio = 0),
      ...
      return (
        c(e, [
          ...
          },
          {
            ...
            value: function (e, t) {
              for (
                var i = h(e), n = i.getPropertyCSSValue(t), o = 0;
